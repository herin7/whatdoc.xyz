                ...
                >
                    ...
                    <div className={`mt-auto border-t px-4 py-4 ${t.sidebarFooter}`}>
                        <p className="text-[10px]">
                            Generated by{' '}
                            <Link to="/" className="opacity-70 hover:opacity-100 transition-opacity font-logo">
                            ...
                            <div className="flex flex-col items-center text-center py-8 sm:py-16">
                                ...
                                <div className="mt-16 pt-8">
                                    <p className="text-xs opacity-30">
                                        ...
                                        <Link to="/" className="underline underline-offset-2 hover:opacity-80 transition-opacity font-logo">
                                            <span className="font-bold">W</span>HATDOC.XYZ
                                        </Link>
                                    </p>
                                </div>
